...
Chat covers two authenticated users, membership, database commit before ACK, realtime delivery, reconnect catch-up, deduplication, attachments, and later multi-pod fan-out.
